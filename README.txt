...
4. Enter the Start, Goal x,y coordinates and theta (Input coordinates are referenced such that the origin is at the top-left corner).
5. Visualization is done after the map is explored and path is found.
6. The videos show the path generated for:
